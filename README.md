...
img { margin: 0; padding: 0; font-size: 0; vertical-align:text-top; }
...
ul { font-size: inherit; list-style-type: square; padding: 0 0 0 30px; margin: 0; }

.returnValue { font-weight: bold; color: #808080; }
.functionName { font-weight: bold; color: #333; text-decoration: underline; }
a.functionName:hover { color: #000; }
...
div.header em { color: #FFFFFF; }

table.functionSet { border-collapse: collapse; width: 100%; border: 1px solid #333; }
table.functionSet th { text-align: left; font-size: 10px; white-space: nowrap; padding: 1px 6px 1px 1px; }
table.functionSet td { text-align: left; font-size: 9px; padding: 3px; }
table.functionSet tr { vertical-align: top; border-bottom: 1px solid #333; }
table.functionSet tr:last-child { border-bottom: 0; }
table.functionSet tr:nth-child(odd) { background-color: #F0F0F0; }
table.functionSet tr.header { background-color: #333; padding: 2px; color: #ccff00; }
table.functionSet tr.header th { padding-left: 8px; font-size: 12px; }
